...
class MostPopularView extends StatefulWidget {
  ...
  @override
  State<MostPopularView> createState() => _MostPopularState();
}

class _MostPopularState extends State<MostPopularView> {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(builder: (context) {
                              return ExerciseDetailPage(
                                ...
                                exerciseName: Constants.exerciseNamesmP[index],
                                muscleImage: Constants.muscleImageP[index],
                              );
                            }),
                          );
                        },
